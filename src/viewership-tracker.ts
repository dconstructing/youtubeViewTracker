...
export class ViewershipTracker {
  ...
  constructor(apiKey?: string) {
    ...
    if (!this.apiKey) {
      throw new Error('YouTube API key is required. Provide it as a parameter or set YOUTUBE_API_KEY environment variable.');
    }
  }
  ...
  async saveStatisticsToJson(statistics: VideoStatistics, outputDir: string = './data'): Promise<string> {
...
export async function createViewershipReport(videoId: string, apiKey?: string, outputDir?: string): Promise<string> {
